...
\fancyfoot[R]{\textcolor{colheadfoot}{\textsf{Updated 2016-07-07}}}
...
\begin{mytabular}
2007--\dots &Referee for \journal{Science}$^*$, \journal{Nature}, \journal{Proceedings of the Royal Society B}$^{***}$, \journal{PNAS}, \journal{Ecology Letters}$^{*}$, \journal{Nature Communications}$^{*}$, \journal{Evolution}$^{**}$, \journal{The American Naturalist}$^{***}$, \journal{PLOS Biology}, \journal{PLOS Computational Biology}$^{*}$, \journal{PLOS One}$^{*}$, \journal{Journal of Theoretical Biology}$^{***}$, \journal{Evolutionary Applications}, \journal{Philosophical Transactions of the Royal Society}, \journal{Theoretical Population Biology}$^*$, \journal{BMC
